...
if __name__ == '__main__':
    ...
    for label in set(df_train['author']):
        ...
        plot_token_frequencies(author_df=df_label, title_prefix=author_name + '_word',
                               output_path='output_charts//50_authors_db//word_frquencies//')
    ...
    for label in set(df_train['author']):
        ...
        plot_token_frequencies(author_df=df_label, referance_column='entities_types',
                               ...
                               output_path='output_charts//50_authors_db//entities_frequencies//')

    # additional stats
    boxplot_length(df_train, out_folder='output_charts//50_authors_db//')
    df_train['char_cnt'] = df_train.text.apply(len)
    boxplot_char_length(df_train, out_folder='output_charts//50_authors_db//')
    plot_panctuation_use(df_train, out_folder='output_charts//50_authors_db//')
    plot_noun_use(df_train, out_folder='output_charts//50_authors_db//')
    plot_author_polarity(df_train, out_folder='output_charts//50_authors_db//')
